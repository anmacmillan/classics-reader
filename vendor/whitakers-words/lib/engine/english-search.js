 ...
 */
export function buildEnglishIndex(entries) {
 ...
 */
export function searchEnglish(index, word, maxResults = 6) {
...
function extractEnglishWords(mean) {
