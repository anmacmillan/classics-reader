#!/usr/bin/env python3
"""Attach Stanza dependency parses to imported Latin, Ancient Greek, Old English or Danish texts.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lang", choices=("latin", "greek", "old_english", "danish"), default="latin", help="Corpus language to parse")
    ...
    pipeline = stanza.Pipeline({"latin": "la", "greek": "grc", "old_english": "ang", "danish": "da"}[args.lang], processors="tokenize,pos,lemma,depparse", tokenize_no_ssplit=False, verbose=False)
